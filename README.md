...
The purpose of this project was to learn how to analyze the data utilizing Excel techniques that include, but are not limited to:
 ...
 ## Analysis and Challenges
  ...
  ![CondintionalFormattingExample.png](Conditional%20Formatting%20Example.png)   
...
The launch date analysis shows and overall success rate of about 65% and a 36% fail rate for theater fundraising. The most successful time frame for fundraising is spring and summer and then it falls off in the fall and winter. ![Theater_Outcomes_vs_Launch.png](Theater_Outcomes_vs_Launch.png)   
